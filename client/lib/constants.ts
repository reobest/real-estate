...
export const headingArray : string[] = ["Trustworthy and verified lestining","Browse rental listings with ease","Simplify your rental search with Advanced"]
export const buttonArray : string[] = ["explore","search","discover"]
export const DescriptionArray : string[] = [" Discover the best rental options with user reviews and ratings",
    "get access to user reviews and ratings for a better understanding of rental options",
    "Find trustworthy and verified rental listings to ensure a hasee-fee experience"]
